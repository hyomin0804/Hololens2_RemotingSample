...
namespace Microsoft.MixedReality.OpenXR.Sample
{
    ...
    public class AppRemotingSample : MonoBehaviour
    {
        ...
        */
        ...
        [SerializeField, Tooltip("The UI Button in the 2D app window to start disconnecting to the player.")]
        ...
        */
        ...
        private void Awake()
        {
            ...
            textInput.text=PlayerPrefs.GetString("textInput", textInput.text);
        ...
        {
            m_connected = true;
            PlayerPrefs.SetString("textInput", textInput.text);
